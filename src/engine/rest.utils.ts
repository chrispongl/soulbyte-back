const HOUSING_REST_PROFILE: Record<string, { restHours: number; recoveryMult: number }> = {
    street: { restHours: 8, recoveryMult: 0.7 },
    shelter: { restHours: 7, recoveryMult: 0.8 },
    slum_room: { restHours: 6, recoveryMult: 0.9 },
    apartment: { restHours: 5, recoveryMult: 1.0 },
    condo: { restHours: 4, recoveryMult: 1.1 },
    house: { restHours: 4, recoveryMult: 1.2 },
